...
namespace GridPrinting {
    public partial class MyPrintDialog : DevExpress.XtraEditors.Preview.PrintEditorForm {
        public MyPrintDialog()
            : base() {
        }
        protected override void OnLoad(EventArgs e) {
            base.OnLoad(e);
            ComboBoxEdit comboBox = typeof(PrintEditorForm).GetField("cbInstalledPrinters", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.GetField | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance).GetValue(this) as ComboBoxEdit;
            if(comboBox != null)
